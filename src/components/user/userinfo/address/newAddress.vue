        ...
        <div v-if="!state">
                ...
                <div class="address">
                        <ul>
                                ...
                                <li><span>邮政编码</span><input type="text" placeholder="请填写邮政编码" v-model="postcode"></li>
                        </ul>
                </div>
                <button @click="add" class="divcsss">发布</button>
                <!-- 地区选择 -->
    ...
    export default {
        ...
        methods: {
            ...
            add(){
                ...
                var url = common.apimain+'/api/address/add';
                    //console.log(url);
                    Indicator.open();
