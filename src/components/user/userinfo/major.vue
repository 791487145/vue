<template>
	<div id="" ref="tmpld">
           <com-header :title="title" :save="save" @show_save="saveMajors"></com-header>
			<section>
				<div class="modifyName">
                    <input type="text" id="nickname" placeholder="输入所学专业" v-model="majors"/>
                </div>
			</section>
	</div>
...
//                console.log(this.title)
			...
			saveMajors () {
				...
				//console.log(token)
				var url = common.apimain + '/api/user/updateMajors';
				var json = {
					token:token,
					majors:this.majors,
				}
